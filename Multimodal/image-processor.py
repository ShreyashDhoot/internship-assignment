...
def run_vlm_inference(image_paths, question_text):
    ...
    content.append({
        "type": "text",
        "text": f"Evaluate the provided portfolio images to answer this question accurately: {question_text}"
    })
...
if __name__ == "__main__":
    dataset_path = r"D:\INTERNSHIP-assigment\Data-set\artist_profiles"
